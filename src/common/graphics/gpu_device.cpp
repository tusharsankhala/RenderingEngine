...
//#define VULKAN_SYNCHRONIZATION_VALIDATION
    ...
    static Engine::FlatHashMap<u64, VkRenderPass> render_pass_cache;
    ...
    //
    //
    static void vulkan_fill_write_descriptor_sets(GpuDevice& gpu, const DescriptorSetLayout* descriptor_set_layout, VkDescriptorSet vk_descriptor_set,
    ...
    VkRenderPass GpuDevice::get_vulkan_render_pass(const RenderPassOutput& output, cstring name) {
        ...
        u64 hashed_memory = Engine::hash_bytes((void*)&output, sizeof(RenderPassOutput));
    ...
    void* GpuDevice::dynamic_allocate(u32 size)
    {
        ...
        dynamic_allocated_size += (u32)Engine::memory_align(size, s_ubo_alignment);
    ...
    {
        Engine::memory_copy(timestamps_to_fill, &timestamps[current_frame * queries_per_frame], sizeof(GPUTimestamp) * current_query);
